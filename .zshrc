...
export ZSH="/home/corp.cyren.com/cmeilke/.oh-my-zsh"
...
POWERLEVEL9K_DIR_ETC_BACKGROUND='008'
...
plugins=(git virtualenv nvm color-ssh poetry)
...
source ~/.bash_aliases
source ~/.bash_aliases.general

export GOPATH=$HOME/go
export PATH=$PATH:/usr/local/go/bin:$GOPATH/bin:$HOME/bin:$HOME/.poetry/bin
